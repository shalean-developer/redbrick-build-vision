          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Ready to discuss your construction project? Contact our team today for a free consultation and quote.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-muted-foreground">
                      <p>
                        Sam:{" "}
                        <a href="tel:+27685943091" className="hover:text-primary">
                          +27 68 594 3091
                        </a>
                      </p>
                      <p>
                        Bishop:{" "}
                        <a href="tel:+27827587466" className="hover:text-primary">
                          +27 82 758 7466
                        </a>
                      </p>
                    </div>
