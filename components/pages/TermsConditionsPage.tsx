          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using Team Edlick Construction&apos;s services, you accept and agree to be bound by these
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">Unless otherwise agreed in writing:</p>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We strive to complete all projects within the agreed timeline. However, completion dates may be affected
                by weather conditions, material availability, or other factors beyond our control. We will communicate
                any delays promptly.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We guarantee the quality of our workmanship. Specific warranty periods will be outlined in your project
                agreement. Warranties do not cover damage resulting from misuse, neglect, or normal wear and tear.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Team Edlick Construction maintains appropriate insurance coverage. Our liability is limited to the value
                of the services provided. We are not liable for indirect or consequential damages.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">For questions about these Terms & Conditions, please contact us:</p>
