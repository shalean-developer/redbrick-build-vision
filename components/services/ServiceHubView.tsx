    ...
    <main className="flex-grow pb-16">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-12 lg:items-center max-w-6xl mx-auto">
            <div>
              <p className="text-sm font-medium text-primary mb-3">
                ...
                <Link href="/locations/cape-town" className="hover:underline text-muted-foreground">
                  Cape Town
                </Link>
              </p>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed border-l-4 border-primary/40 pl-4">
                {hub.trustLine}
              </p>
              <p className="mt-6">
                <Link
      ...
      <section className="py-12 md:py-16 bg-muted/50 border-b border-border/60">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-2">
            {hub.proofSectionTitle ?? "On-site project proof"}
          </h2>
          <p className="text-muted-foreground mb-8 max-w-2xl">
            Recent Cape Town metro scopes (representative categories). Tap through to the{" "}
            <Link href="/projects" className="text-primary font-medium hover:underline">
              projects index
            </Link>{" "}
            or your{" "}
            <Link href={cityLandingHref} className="text-primary font-medium hover:underline">
              local {service.name.toLowerCase()} hub
            </Link>
            .
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            {hub.narrativeSectionTitle ?? `How we run ${service.name.toLowerCase()} in Cape Town`}
          </h2>
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-2">What this service includes</h3>
              <p>{hub.whatIncludes}</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-2">Where it is used</h3>
              <p>{hub.whereUsed}</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-2">Who it is for</h3>
              <p>{hub.whoItsFor}</p>
            </div>
          </div>
          <div className="mt-8 rounded-lg border bg-primary/5 px-4 py-4 text-sm text-foreground leading-relaxed">
            <span className="font-semibold text-primary">Materials &amp; systems: </span>
            {money.materialsNote}
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-muted/40 border-y border-border/60">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-muted-foreground mb-8">
            Practical outcomes our crews target on every {service.name.toLowerCase()} programme.
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-3">
            {hub.locationSectionTitle ?? `Our ${service.name.toLowerCase()} services in Cape Town`}
          </h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
            We mobilise across the Cape Town metro and surrounding corridors, including{" "}
            <span className="text-foreground font-medium">{suburbText}</span>
            . Regional coastal conditions inform how we specify adhesives, membranes, and coatings.
          </p>
          <p className="mb-6">
            <Link href={cityLandingHref} className="inline-flex font-semibold text-primary hover:underline">
              {hub.locationCtaLabel ??
                `Open the full ${service.name} in Cape Town page (pricing, process & FAQs) →`}
            </Link>
          </p>
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/contact" className="text-primary font-medium hover:underline">
              send site photos for a scoped quote
            </Link>
            .
          </p>
        </div>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-muted-foreground mb-8">
            A straight-line sequence so expectations stay aligned from first visit to handover.
          </p>
          <ol className="space-y-6 list-none m-0 p-0">
            {processSteps.map((step, i) => (
              <li key={step.title} className="flex gap-4">
                <span
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground font-bold text-sm"
                  aria-hidden
                >
                  {i + 1}
                </span>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {testimonials.map((t) => (
              <blockquote
                key={t.byline}
                className="rounded-lg border bg-background p-6 shadow-card text-foreground leading-relaxed"
              >
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-muted-foreground mb-6">
            Bundling trades usually saves programme time on renovations and external upgrades.
          </p>
            ...
            {related.map((s) => (
              <li key={s.slug}>
                <Link
                  ...
                  className="flex items-center justify-between rounded-lg border bg-background px-4 py-3 font-medium text-foreground hover:border-primary/50 hover:text-primary transition-colors"
                >
                  {s.name}
      ...
      <section className="py-14 md:py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-balance">
            {hub.finalCtaHeading ?? "Get a quote within 24 hours"}
          </h2>
          <p className="text-lg opacity-95 mb-8 leading-relaxed">
            Share your suburb, photos, and scope. We respond with structured pricing options and next steps for{" "}
            {service.name.toLowerCase()} in Cape Town.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="font-semibold border-primary-foreground/40 text-primary-foreground bg-transparent hover:bg-primary-foreground/10"
            >
              <a href={waUrl} target="_blank" rel="noopener noreferrer">
                WhatsApp the team
              </a>
